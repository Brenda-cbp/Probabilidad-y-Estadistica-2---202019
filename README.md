 ...
 ********
**Este es un curso increíblemente útil, que cubre temas muy interesantes y para nada complicados, los cuales nos dan abren la puerta a un conjunto de aplicaciones, modelos y habilidades gigantesca. Esperamos disfruten el curso, tanto como nosotros disfrutamos darlo.** :sunglasses:         :bar_chart:
